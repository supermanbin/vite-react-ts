...
export default function Input({className,inputFor, labelText, placeholder, type, value, onChange}:InputProps) {
  ...
  return (
    <div className={`${className?className:''}`}>
      ...
      <input className={`${inputCls}`} type={type} placeholder={placeholder} onChange={(e) => {onChangeHandle(e)}} value={value}  />
    </div>
  )
}